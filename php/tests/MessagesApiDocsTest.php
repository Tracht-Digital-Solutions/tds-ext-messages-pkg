 ...
 */
final class MessagesApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new MessagesModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new MessagesModule())->permissions(),
        );

        foreach ((new MessagesModule())->apiDocs() as $doc) {
